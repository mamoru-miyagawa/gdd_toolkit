...
| 14 | **False consensus** | All features pass the Pillar Gate because the pillars are too vague. "Fun." "Engaging." "Immersive." These filter nothing. | Vision Lock — pillars must be specific enough to be challenged. A pillar that can't be questioned is not a pillar. |
